...
class CountryPickerTextField: UITextField, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    public  var closureIntialCountry: ((_ image: World.Country ) -> Void)?
    ...
    //    pickerView.selectRow(228, inComponent: 0, animated: true)
        ...
        if let index = pickerView.selectedRow(inComponent: 0) as Int? {
           ...
           // let country: World.Country = world.countryList[228]
            let country: World.Country = world.countryList[99]
             closureIntialCountry?(country)
            
            self.text = "\(flag(country.sortName)) \(country.sortName) \(country.code)"
        }
        
    }
    
    func first() -> World.Country {
        return     world.countryList[99] //India
        //return     world.countryList[228] // USA
    }
 ...
 //       arraybutton.append(donebutton)
    ...
    func pickerView(_ pickerView: UIPickerView, titleForRow row: Int, forComponent component: Int) -> String? {
        ...
        return " \(flag(country.sortName)) \(country.sortName) \(country.code)  \(country.name)"
